...
export default function About() {
  ...
  return (
    <>
      ...
      >
        <div>
          <h1 className="display-3 fw-bold text-dark mb-3">About</h1>
      ...
      <section className="about-section py-5 py-lg-5 bg-white my-1">
          ...
          <div className="row g-0 align-items-center">
            ...
            <div className="col-lg-6 ps-lg-5 mt-4 mt-lg-0">
              <div className="about-content">
                ...
                <div className="row g-3 g-sm-4 mb-4 mb-lg-5">
                  ...
                  <div className="col-6">
                    <div className="stat-card p-4 text-center border shadow-sm bg-white rounded">
                      ...
                      <h2 className="stat-number fw-bold mb-1" style={{ color: '#B88A4A' }}>999+</h2>
                ...
                <div className="about-btn-container">
                  <div className="custom-frame-btn">
                    <Link to="/contact" className="btn-read-more-text text-decoration-none">
                      CONTACT US
                    </Link>
                  </div>
                </div>
